...
class CalculatorTests {
    ...
    void devidewereese(String first, int second, int expectedResult) {
        Calculator calculator = new Calculator();
        assertEquals(expectedResult, calculator.devidewereese(first, second),
                () -> first + " / " + second + " should equal " + expectedResult);
    }
    ...
    void newFunDev(String first, int second, int expectedResult) {
        Calculator calculator = new Calculator();
        assertEquals(expectedResult, calculator.newFunDev(first, second),
                () -> first + " / " + second + " should equal " + expectedResult);
    }
    ...
    void newFunFunDev(String first, int second, int expectedResult) {
        Calculator calculator = new Calculator();
    ...
    void newFunctiosddsn(String first, int second, int expectedResult) {
        Calculator calculator = new Calculator();
        assertEquals(expectedResult, calculator.newFunctionsdadfsds(first, second),
                () -> first + " / " + second + " should equal " + expectedResult);
    }
}